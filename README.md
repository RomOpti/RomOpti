...
Made by [@rrromuluss](https://github.com/RomOpti) (YouTube / Discord).
...
1. Go to the [latest files](https://github.com/RomOpti/RomOpti) and download **both** `Rom-Opti.ps1` and `Run-RomOpti.bat` into the **same folder**.
2. Double-click **`Run-RomOpti.bat`**.
